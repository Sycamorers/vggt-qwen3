...
- A **Qwen3‑4B‑Instruct** text decoder loaded through
  `AutoModelForCausalLM.from_pretrained(...)` and currently fine‑tuned
  end‑to‑end on 3D QA datasets (ScanQA + SQA3D), without LoRA/PEFT injection.
